...
const zh = {
  ...
  __COMMAND_ANALYZE_SITUATION_DASHBOARD_LABEL: '全球情勢監控儀表板',
  __COMMAND_ANALYZE_SITUATION_DASHBOARD_TEXT: '全球情勢監控儀表板',
  __COMMAND_ANALYZE_SITUATION_DASHBOARD_PROMPT: '請根據以下需求產出完整產品規劃：製作即時全球情勢監控儀表板，整合 30+ 新聞來源、市場數據與聯準會指標。內建分析引擎需自動偵測新聞關聯、追蹤敘事傳播，並識別當日新聞主角，形成適合投資人、研究員與新聞從業者的個人情報中心。請重點解決：資訊碎片化、即時性不足、缺乏關聯分析、假訊息敘事追蹤困難、市場與新聞整合不足，以及可自訂關鍵字/議題警報需求。請提供功能模組、資料架構、分析方法、警報策略、MVP 路線圖與衡量指標。',
