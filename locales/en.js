...
const en = {
  ...
  __COMMAND_ANALYZE_SITUATION_DASHBOARD_LABEL: 'Global Situation Dashboard',
  __COMMAND_ANALYZE_SITUATION_DASHBOARD_TEXT: 'Global Situation Dashboard',
  __COMMAND_ANALYZE_SITUATION_DASHBOARD_PROMPT: 'Create a complete product plan for a real-time global situation monitoring dashboard that integrates 30+ news sources, market data, and Federal Reserve indicators. The built-in analysis engine should detect news relationships, trace narrative propagation, and identify the daily key actors. Target users include investors, researchers, and journalists building a personal intelligence center. Focus on solving fragmented information, real-time update gaps, missing relationship analysis, misinformation narrative tracking, weak news-market integration, and customizable keyword/topic alerts. Provide feature modules, data architecture, analysis methods, alert strategy, MVP roadmap, and success metrics.',
