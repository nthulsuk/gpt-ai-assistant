...
const ja = {
  ...
  __COMMAND_ANALYZE_SITUATION_DASHBOARD_LABEL: 'グローバル情勢ダッシュボード',
  __COMMAND_ANALYZE_SITUATION_DASHBOARD_TEXT: 'グローバル情勢ダッシュボード',
  __COMMAND_ANALYZE_SITUATION_DASHBOARD_PROMPT: '30以上のニュースソース、市場データ、FRB指標を統合するリアルタイムのグローバル情勢監視ダッシュボードについて、完全なプロダクト計画を作成してください。分析エンジンはニュースの関連性検出、ナラティブ拡散の追跡、当日の主要アクター特定を行い、投資家・研究者・報道関係者向けの個人インテリジェンスセンターを実現します。情報の分断、即時性不足、関連分析不足、偽情報ナラティブ追跡の困難さ、市場データとニュース統合不足、キーワード/トピックのカスタム監視アラートを重点課題として扱ってください。機能モジュール、データ設計、分析手法、アラート戦略、MVPロードマップ、評価指標を提示してください。',
